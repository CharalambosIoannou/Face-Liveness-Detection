...
model = build(width=32, height=32, depth=3,
						  classes=2)
np.savetxt(f'../feature_extraction/features_Detectedface.csv', model.predict(trainX, batch_size=BS), delimiter=',')
np.savetxt(f'../feature_extraction/labels_Detectedface.csv', trainY, delimiter=',')

np.savetxt(f'../feature_extraction/features_face_both_eyes.csv', model.predict(trainX1, batch_size=BS), delimiter=',')
np.savetxt(f'../feature_extraction/labels_face_both_eyes.csv', trainY1, delimiter=',')

np.savetxt(f'../feature_extraction/features_face_no_left_eye.csv', model.predict(trainX2, batch_size=BS), delimiter=',')
np.savetxt(f'../feature_extraction/labels_face_no_left_eye.csv', trainY2, delimiter=',')

np.savetxt(f'../feature_extraction/features_face_no_mouth.csv', model.predict(trainX3, batch_size=BS), delimiter=',')
np.savetxt(f'../feature_extraction/labels_face_no_mouth.csv', trainY3, delimiter=',')

np.savetxt(f'../feature_extraction/features_face_no_nose.csv', model.predict(trainX4, batch_size=BS), delimiter=',')
np.savetxt(f'../feature_extraction/labels_face_no_nose.csv', trainY4, delimiter=',')

np.savetxt(f'../feature_extraction/features_face_no_right_eye.csv', model.predict(trainX5, batch_size=BS), delimiter=',')
np.savetxt(f'../feature_extraction/labels_face_no_right_eye.csv', trainY5, delimiter=',')
